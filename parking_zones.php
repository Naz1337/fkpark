...
<form action="parking_zones.php" method="get" class="form-search d-flex align-items-center">
    ...
    <input type="text" id="search_space" name="search_space" placeholder="Enter parking space name or parking zone name" class="form-control me-2" style="max-width: 25rem;">
...
<table border="1" class="table table-bordered">
    ...
    <tbody>
        ...
        if (isset($_GET['search_space']) && !empty($_GET['search_space'])) {
            ...
            $sql_spaces .= " WHERE ps.name LIKE '%$search_query%' OR pz.name LIKE '%$search_query%'";
        }
